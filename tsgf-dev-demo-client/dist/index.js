...
/**demo服务器的客户端封装*/
class DemoClient extends tsgfSdk.AHttpClient {
    ...
    async playerAuth(playerOpenId, playerShowName) {
        ...
        if (!ret.isSucc) {
            return tsgfSdk.Result.buildErr(ret.err.message, ((_a = ret.err.code) !== null && _a !== void 0 ? _a : 1));
        }
        return tsgfSdk.Result.buildSucc(ret.res);
    }
}
